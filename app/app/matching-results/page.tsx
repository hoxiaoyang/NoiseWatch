...
export default function MatchingResultsPage() {
  ...
  useEffect(() => {
    // Get complaint data from sessionStorage
    ...
    // Simulate API call to search for matches
  ...
  const handleVerificationConfirm = async (verification: IdentityVerification) => {
    // Store all data for success page
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-medium text-gray-900">
                    Block {complaintData.blockNumber}, Unit {complaintData.unitNumber}
                  </span>
                </div>
                <div>
